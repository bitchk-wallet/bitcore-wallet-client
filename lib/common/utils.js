...
var _networks = Bitcore.Networks.networks;
var Bitcore_ = {};
for (var index in _networks) {
    var net = _networks[index];
    if (net.coin == 'bch')
        Bitcore_[net.coin] = require('bitcore-lib-cash');
    else if (net.coin)
        Bitcore_[net.coin] = require('bitcore-lib');
}
...
Utils.buildTx = function(txp) {
    ...
    $.checkState(txp.coin, "invalid input. need coin");
